...
/**
 * Servlet implementation class ScheduledTrips
 */
public class ScheduledTripsServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ScheduledTripsServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet rs = pstmt.executeQuery(
                    "select * from trips where status = 'scheduled' and customerid = '" + tempUser.getEmail() + "'");
