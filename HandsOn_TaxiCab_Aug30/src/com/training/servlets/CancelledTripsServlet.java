...
/**
 * Servlet implementation class CancelledTripsServlet
 */
public class CancelledTripsServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public CancelledTripsServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet rs = pstmt.executeQuery(
                    "select * from trips where status = 'cancelled' and customerid = '" + tempUser.getEmail() + "'");
        ...
        request.setAttribute("CancelledTrips", alist);

        RequestDispatcher dispatcher = request.getRequestDispatcher("CancelledTrips.jsp");
