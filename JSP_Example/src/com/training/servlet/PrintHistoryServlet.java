...
import com.training.models.PaymentStatus;
import com.training.models.StatusFinder;

/**
 * Servlet implementation class PrintHistoryServlet
 */
public class PrintHistoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("PrintHistory.jsp");
